  ...
  render() {
    return (
      <div className='privacy'>
        ...
        <p>When you sign up to become a Registered User, you will be asked to provide us with certain personal information, such as your name, email address, birth date (“Personal Information”). If you choose to purchase Products through the Service, you will be asked to provide your billing address, shipping address and credit card information (“Transaction Information”).</p>
        <p>Like most web sites, we use automatic data collection technology when you visit our Site to record information that identifies your computer, to track your use of our Site, and to collect certain basic information about you and your surfing habits. This information includes information about your operating system, your IP addresses, browser type and language, referring and exit pages and URLs, keywords, date and time, amount of time spent on particular pages, what sections of a website you visit, and similar information concerning your use of the Site and the Service (the “Usage Information”).</p>
        ...
        <p>We do not collect personally identifying information in this way, but if you’ve provided us with personally identifying information we may associate that information with the information that is collected automatically. Automatic data collection may be performed on our behalf by our services providers.</p>
        <p>We may also allow third-party companies that are presenting advertisements on the Site to set and access their own cookies. Such third-party cookies are not governed by this Privacy Policy, but by the privacy policies of such third party.</p>
        <h4 class="help-question">Information Collected by or Through Third-Party Companies</h4>
        <p>We may share Usage Information about your activity on the Site with third parties for the purpose of tailoring, analyzing, managing, reporting, and optimizing advertising you see on the Site, and elsewhere. These third parties may use cookies, pixel tags (also called web beacons or clear gifs), and/or other technologies to collect such Usage Information for such purposes. Pixel tags enable us and these third-parties to recognize a browser’s cookie when a browser visits the site on which the pixel tag is located in order to learn which advertisement brings a user to a given site.</p>
        <p>We may share your Personal Information, and non-personal information, including your name, address, email address and any transactions you conduct on our Site or offline with us with a third party advertising partner and its service providers in order to deliver tailored advertising to you that match your interests when you visit our Site as well as other websites. Our advertising partner will make the data that we provide anonymous so that no one else will receive your Personal Information.</p>
        <h4 class="help-question">Opt Out Options</h4>
        ...
        <p>We may also use your information to improve our Site, and may use cookies and other information to enable us to customize your user experience.</p>
        <p>We will share your Transaction Information with trusted third parties as necessary to process and fulfill your order. All such third parties are contractually obligated to keep all Transaction Information confidential, maintain the privacy of all Registered Users, and to use such Transaction Information only to provide services to Function Earth for the benefit of Function Earth and its Registered Users. Transaction Information may also be used to develop a personalized profile and shopping history for each Registered User in order to customize promotions, updates or special offers.</p>
        ...
        <p>If we or all or substantially all of our assets are acquired, we expect that the information that we have collected, including personally identifying information, would be transferred along with our other business assets.</p>
        <p>We may disclose Personal Information and Usage Information to government authorities, and to other third parties when compelled to do so by government authorities, at our discretion, or otherwise as required by law, including but not limited to in response to court orders and subpoenas. We also may disclose Personal Information and the Usage Information when we have reason to believe that someone is or may be causing injury to or interference with our rights or property, other users of this Site, or anyone else that could be harmed by such activities.</p>
        <h4 class="help-question">Function Earth Blog Content</h4>
        <p>We are not responsible for protecting any Personal Information that you post on our blog or on social media web pages associated with Function Earth. Although we reserve the right to monitor any postings, all Personal Information that is posted on these websites is unprotected and can be seen by anyone with access to the Site.</p>
        <h4 class="help-question">How We Protect Your Information</h4>
        ...
        <h4 class="help-question">Accessing and Modifying Account Information</h4>
        <p>You may update the information that is stored in your user account in by visiting by e-mailing us at <a href="mailto:support@functionearth.com" class="light-blue-link">support@functionearth.com</a>.</p>
        <h4 class="help-question">Your Choices</h4>
        <p>If you wish to stop receiving promotional e-mails, you may do so by e-mailing <a href="mailto:support@functionearth.com" class="light-blue-link">support@functionearth.com</a>.</p>
        <h4 class="help-question">Links</h4>
        <p>This Site contains content, services, advertising and other materials that link to web sites operated by third parties. We have no control over those other sites, and this Privacy Policy does not apply to them.</p>
        <h4 class="help-question">Important Notice to Non-U.S. Residents</h4>
        <p>The Site and the Service are operated in the United States. If you are located outside of the United States, please be aware that any information you provide to us will be transferred to the United States. By using the Service and/or providing us with any information, you consent to this transfer.</p>
        <h4 class="help-question">Collection of Information from Minors</h4>
        <p>We do not knowingly collect Personal Information from minors under 21, nor do we direct any of our content to minors under 21. If we learn that we collected the Personal Information of a minor, we will take steps to delete the information as soon as possible.</p>
        <h4 class="help-question">Changes to This Privacy Policy.</h4>
        ...
        <h4 class="help-question">How to Contact Us</h4>
        <p>If you have questions about this Privacy Policy, please e-mail us at <a href="mailto:support@functionearth.com" class="light-blue-link">support@functionearth.com</a>, “PRIVACY POLICY” in the subject line.</p>
    </div>
    );
  }
}
